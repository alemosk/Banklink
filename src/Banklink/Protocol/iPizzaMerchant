 ...
 * @since  11.01.2012
 */
class iPizzaMerchant extends iPizza
{
    protected $publicKey;
     ...
     */
    public function __construct($sellerId, $privateKey, $publicKey, $endpointUrl, $cancelUrl, $mbStrlen = false, $version = '008')
    {
    ...
    public function preparePaymentRequestData($orderId, $sum, $message, $outputEncoding, $language = 'EST', $currency = 'EUR')
    {
        ...
        $requestData = array(
            Fields::SERVICE_ID       => Services::PAYMENT_REQUEST_MERCHANT,
